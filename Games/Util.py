...
strilecka_session_log = pd.read_csv('%s/CSV/strilecka_session_log.csv' % (parent[0]), header = 0, sep = ';', parse_dates=['time'])
...
roboti_session_log = pd.read_csv('%s/CSV/roboti_session_log.csv' % (parent[0]), header = 0, sep = ';', parse_dates=['time'])
...
tetris_session_log = pd.read_csv('%s/CSV/tetris_session_log.csv' % (parent[0]), header = 0, sep = ';', parse_dates=['time'])
